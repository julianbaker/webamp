...
A Winamp‑style player that showcases the **Open Audio Protocol** through Audius streaming and discovery. This fork turns Webamp into a focused, Audius‑first experience with a native in‑app browser and playlist‑first workflows.

[![Screenshot of Webamp](https://raw.githubusercontent.com/julianbaker/webamp/master/packages/webamp/demo/images/preview.png)](https://webamp.org)

Works in modern versions of Edge, Firefox, Safari and Chrome. IE is [not supported](http://caniuse.com/#feat=audio-api).

## What this fork adds

- Audius browser window (Trending + Search)
- Add by Audius URL (track, playlist, or user)
- Audius‑first playlist population via browsing and Add URL
- Winamp‑faithful styling that keeps the classic UI feel

## Powered by the Open Audio Protocol

This project integrates [Audius](https://audius.co), which is built on the Open Audio Protocol, to stream and browse music via their public API. The goal is to make the protocol tangible: search, discovery, and playback in a familiar, nostalgic interface that highlights what open audio infrastructure enables.

## Read the docs

**The [Webamp Documentation](https://docs.webamp.org) site contains detailed instructions for the upstream project. This fork diverges in Audius-related behavior, but the core setup concepts still apply.**

## About This Repository

This repository started as the Webamp monorepo and still contains the original package layout. The focus of this fork is the Audius-enabled player experience; some packages may remain primarily for upstream compatibility or development convenience.
...
- [`packages/webamp`](https://github.com/julianbaker/webamp/tree/master/packages/webamp): The [Webamp NPM module](https://www.npmjs.com/package/webamp)
- [`packages/webamp/demo`](https://github.com/julianbaker/webamp/tree/master/packages/webamp/demo): The demo site which lives at [webamp.org](https://webamp.org)
- [`packages/webamp-docs`](https://github.com/julianbaker/webamp/tree/master/packages/webamp-docs): The documentation site for Webamp the NPM library which lives at [docs.webamp.org](https://docs.webamp.org)
- [`packages/ani-cursor`](https://github.com/julianbaker/webamp/tree/master/packages/ani-cursor): An NPM module for rendering animiated `.ani` cursors as CSS animations
- [`packages/skin-database`](https://github.com/julianbaker/webamp/tree/master/packages/skin-database): The server component of https://skins.webamp.org which also runs our [Twitter bot](https://twitter.com/winampskins), and a Discord bot for our community chat
- [`packages/winamp-eqf`](https://github.com/julianbaker/webamp/tree/master/packages/winamp-eqf): An NPM module for parsing and constructing Winamp equalizer preset files (`.eqf`)
- [`packages/webamp-modern`](https://github.com/julianbaker/webamp/tree/master/packages/webamp-modern): A prototype exploring rendering "modern" Winamp skins in the browser
- [`examples`](https://github.com/julianbaker/webamp/tree/master/examples): A few examples showing how to use the NPM module

## Community

Upstream Webamp community links are preserved below for reference; this fork does not share the same community infrastructure.
...
The list below is from upstream Webamp and does not necessarily apply to this fork.
...
## Acknowledgments (Upstream Webamp)

This project is a fork of [Webamp](https://github.com/captbaritone/webamp). All credit for the original Webamp implementation and design goes to Jordan Eldredge and contributors. The links below are preserved for attribution and context.

For upstream background, see this [Twitter thread](https://twitter.com/captbaritone/status/961274714013319168) and the original Webamp documentation.
